...
public class Solution {
    ...
    public static void add(List<? super C> destinationList, List<? extends C> sourceList) {
        ListIterator<? super C> destListIterator = destinationList.listIterator();
        ListIterator<? extends C> srcListIterator = sourceList.listIterator();
